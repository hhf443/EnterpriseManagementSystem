<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="Web.Admin.AddProduct" MasterPageFile="Admin.master" %>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
        <tr>
            <td height="28" style=" background-image:url(images/title_bg1.jpg)">当前位置: 产品添加页面</td>
        </tr>
        <tr>
